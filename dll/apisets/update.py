'''
PROJECT:     MergeOS apisets generator
...
def run(wineroot):
    ...
    manifest_name = 'x86_mergeos.apisets_6595b64144ccf1df_1.0.0.0_none_deadbeef.manifest'
