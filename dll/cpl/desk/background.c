 ...
 * PROJECT:         MergeOS Display Control Panel
...
/* Add the images in the C:\MergeOS, the wallpaper directory and the current wallpaper if any */
static VOID
...
#undef IDI_SHELL_NO
    ...
    /* Add all the images in the C:\MergeOS directory. */
