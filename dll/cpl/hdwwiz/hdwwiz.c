/*
 * MergeOS New devices installation
 * Copyright (C) 2005, 2008 MergeOS Team
 *
 ...
 */
/*
 * PROJECT:         MergeOS Add hardware control panel
 * FILE:            dll/cpl/hdwwiz/hdwwiz.c
 * PURPOSE:         MergeOS Add hardware control panel
