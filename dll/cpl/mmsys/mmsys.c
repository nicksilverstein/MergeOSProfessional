/*
 *
 * PROJECT:         MergeOS Multimedia Control Panel
 * FILE:            dll/cpl/mmsys/mmsys.c
 * PURPOSE:         MergeOS Multimedia Control Panel
 * PROGRAMMER:      Thomas Weidenmueller <w3seek@mergeos.com>
