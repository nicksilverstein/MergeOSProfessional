...
#ifdef __MERGEOS__ /* CORE-16466 part 1 of 4 */
...
static INT LISTVIEW_UpdateVScroll(LISTVIEW_INFO *infoPtr)
{
...
#ifdef __MERGEOS__ /* CORE-16466 part 2 of 4 */
    ...
    {
#ifdef __MERGEOS__ /* CORE-16466 part 3a of 4 */
      if (vertInfo.nPage != 0)
      {
#endif
	...
	if(vertInfo.nPage < infoPtr->nItemHeight)
	  vertInfo.nPage = infoPtr->nItemHeight;
        ...
        if (infoPtr->nItemHeight > 0)
            vertInfo.nPage /= infoPtr->nItemHeight;
#ifdef __MERGEOS__ /* CORE-16466 part 3b of 4 */
      }
#endif
    }
...
#ifdef __MERGEOS__ /* CORE-16466 part 4 of 4 */
