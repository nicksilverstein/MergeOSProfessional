...
/*    // *** IDockingWindowFrame methods ***
    ...
    */
    ...
    LRESULT OnAboutMergeOS(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL &bHandled);
    ...
    BEGIN_MSG_MAP(CShellBrowser)
        ...
        COMMAND_ID_HANDLER(IDM_HELP_ABOUT, OnAboutMergeOS)
...
LRESULT CShellBrowser::OnAboutMergeOS(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL &bHandled)
{
    ShellAbout(m_hWnd, _T("MergeOS"), NULL, NULL);
    return 0;
}
