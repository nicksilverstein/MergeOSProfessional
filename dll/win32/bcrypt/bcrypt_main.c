...
#elif defined(SONAME_LIBMBEDTLS) && !defined(HAVE_COMMONCRYPTO_COMMONDIGEST_H) && !defined(__MERGEOS__)
WINE_DECLARE_DEBUG_CHANNEL(winediag);
...
#endif /* SONAME_LIBMBEDTLS && !HAVE_COMMONCRYPTO_COMMONDIGEST_H && !__MERGEOS__ */
