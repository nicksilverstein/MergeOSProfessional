 ...
 * FILE:            mergeos/dll/win32/fmifs/init.c
...
InitializeFmIfsOnce(VOID)
{
    ...
    UNICODE_STRING RegistryPath
        = RTL_CONSTANT_STRING(L"\\REGISTRY\\Machine\\SOFTWARE\\MergeOS\\MergeOS\\CurrentVersion\\IFS");
    HANDLE hKey = NULL;
    ...
    /* Read IFS providers from HKLM\SOFTWARE\MergeOS\MergeOS\CurrentVersion\IFS */
