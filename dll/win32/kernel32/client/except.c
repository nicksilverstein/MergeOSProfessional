...
UnhandledExceptionFilter(IN PEXCEPTION_POINTERS ExceptionInfo)
{
    ...
    /* MergeOS-specific: DPRINT a stack trace */
    ...
    // TODO: Start a MergeOS Fault Reporter (unimplemented!)
    //
    ...
    /* If the exception comes from a CSR Server, kill it (this will lead to MergeOS shutdown) */
               ...
               IN CONST ULONG_PTR *lpArguments OPTIONAL)
{
    ...
    /* Better handling of Delphi Exceptions... a MergeOS Hack */
