                      ...
                      IN ULONG ImageMinorVersion)
{
    ...
    {
        /* MergeOS-specific: Accept images even if they are newer than our internal NT version. */
        ...
        {
            DPRINT1("Accepting image version %lu.%lu, although MergeOS is an NT %hu.%hu OS!\n",
                ImageMajorVersion,
                ImageMinorVersion,
...
BasepCheckWebBladeHashes(IN HANDLE FileHandle)
{
    ...
    {
        DPRINT1("Egad! This is a MergeOS Compute Server and we should prevent you from using certain APIs...but we won't.");
    }
    else if (SharedUserData->SuiteMask & VER_SUITE_STORAGE_SERVER)
    {
        DPRINT1("Gasp! This is a MergeOS Storage Server and we should prevent you from using certain APIs...but we won't.");
    }
    else if (SharedUserData->SuiteMask & VER_SUITE_BLADE)
    {
        DPRINT1("Golly! This is a MergeOS Web Blade Server and we should prevent you from using certain APIs...but we won't.");
    }
...
StartScan:
    ...
    switch (Status)
    {
        ...
        {
            /* 64-bit binaries are not allowed to run on 32-bit MergeOS */
    ...
    {
        /* This should not happen in MergeOS yet */
