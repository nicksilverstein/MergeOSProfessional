...
Language=German
ERROR_REM_NOT_LIST - MergeOS konnte den Netzwerkpfad nicht finden. Stellen Sie sicher, dass der Netzwerkpfad korrekt ist und der Zielcomputer nicht belegt oder aus ist. Wenn MergeOS den Netzwerkpfad immer noch nicht finden kann, kontaktieren Sie den Netzwerkadministrator.
.
...
Language=German
ERROR_NET_OPEN_FAILED - Die NtCreateFile-API schlug fehl. Dieser Fehler sollte nie einem Programm zurückgegeben werden, es ist ein Platzhalter für den MergeOS Lan Manager Redirector zur verwendung in dessen internen Fehlerbehandlungsroutinen.
.
...
Language=German
ERROR_LOST_WRITEBEHIND_DATA - MergeOS konnte nicht alle Daten für die Datei %hs speichern, die Daten gingen verloren. Dieser Fehler könnte von einer fehlerhaften Hardware oder einer getrennten Netzwerkverbindung kommen. Bitte versuchen Sie, die Datei woanders zu speichern.
.
...
Language=German
ERROR_EVALUATION_EXPIRATION - MergeOS ist ein freies Open-Source-Betriebsystem und lizenziert under der GNU GPL.  Daher gibt es auch keine Evaluationszeit, die ablaufen könnte. Wenn Sie diesen Fehler sehen, dann lesen Sie vermutlich den Quellcode.
.
...
Language=German
ERROR_ILLEGAL_DLL_RELOCATION - Die System-DLL %hs wurde im Speicher neu adressiert. Die Anwendung wird nicht korrekt funktionieren. Die Neuadressierung wurde durchgeführt, weil die DLL %hs einen Adressbereich belegte, der für MergeOS-System-DLLs reserviert ist. Der Entwickler sollte wegen Auslieferung einer neuen DLL kontaktiert werden.
.
...
Language=German
ERROR_COMMITMENT_MINIMUM - Ihr System hat nur noch wenig virtuellen Speicher. MergeOS vergrößert ihre Pagingdatei. Während dieses Vorgangs könnten Speicheranfragen von Anwendungen abgelehnt werden. Für weitere Informationen siehe Hilfe.
.
...
Language=German
ERROR_DS_VERSION_CHECK_FAILURE - This version of MergeOS is not compatible with the behavior version of directory forest, domain or domain controller.
.
...
Language=German
ERROR_GUID_SUBSTITUTION_MADE - During the translation of a global identifier (GUID) to a MergeOS security ID (SID), no administratively-defined GUID prefix was found. A substitute prefix was used, which will not compromise system security. However, this may provide a more restrictive access than intended.
.
...
Language=German
ERROR_FIRMWARE_UPDATED - MergeOS hat festgestellt, dass die Systemfirmware (BIOS) aktualisiert wurde [voriges Firmwaredatum = %2, aktuelles Firmwaredatum = %3].
.
...
Language=German
ERROR_OLD_WIN_VERSION - The specified program requires a newer version of MergeOS.
.
...
Language=German
ERROR_NETWORK_UNREACHABLE - The network location cannot be reached. For information about network troubleshooting, see MergeOS Help.
.
...
Language=German
ERROR_HOST_UNREACHABLE - The network location cannot be reached. For information about network troubleshooting, see MergeOS Help.
.
...
Language=German
ERROR_PROTOCOL_UNREACHABLE - The network location cannot be reached. For information about network troubleshooting, see MergeOS Help.
.
...
Language=German
ERROR_HOST_DOWN - The remote system is not available. For information about network troubleshooting, see MergeOS Help.
.
...
Language=German
ERROR_ACCESS_DISABLED_BY_POLICY - MergeOS cannot open this program because it has been prevented by a software restriction policy. For more information, open Event Viewer or contact your system administrator.
.
...
Language=German
ERROR_ACCESS_DISABLED_WEBBLADE - MergeOS cannot open this program since it has been disabled.
.
...
Language=German
ERROR_ACCESS_DISABLED_WEBBLADE_TAMPER - MergeOS cannot open this program because the license enforcement system has been tampered with or become corrupted.
.
...
Language=German
ERROR_INSTALL_SERVICE_FAILURE - The MergeOS Installer service could not be accessed. This can occur if you are running MergeOS in safe mode, or if the MergeOS Installer is not correctly installed. Contact your support personnel for assistance.
.
...
Language=German
ERROR_INSTALL_PACKAGE_VERSION - This installation package cannot be installed by the MergeOS Installer service. You must install a MergeOS service pack that contains a newer version of the MergeOS Installer service.
.
...
Language=German
ERROR_INSTALL_PACKAGE_OPEN_FAILED - This installation package could not be opened. Verify that the package exists and that you can access it, or contact the application vendor to verify that this is a valid MergeOS Installer package.
.
...
Language=German
ERROR_INSTALL_PACKAGE_INVALID - This installation package could not be opened. Contact the application vendor to verify that this is a valid MergeOS Installer package.
.
...
Language=German
ERROR_INSTALL_UI_FAILURE - There was an error starting the MergeOS Installer service user interface. Contact your support personnel.
.
...
Language=German
ERROR_CREATE_FAILED - The MergeOS Installer service failed to start. Contact your support personnel.
.
...
Language=German
ERROR_PATCH_PACKAGE_OPEN_FAILED - This patch package could not be opened. Verify that the patch package exists and that you can access it, or contact the application vendor to verify that this is a valid MergeOS Installer patch package.
.
...
Language=German
ERROR_PATCH_PACKAGE_INVALID - This patch package could not be opened. Contact the application vendor to verify that this is a valid MergeOS Installer patch package.
.
...
Language=German
ERROR_PATCH_PACKAGE_UNSUPPORTED - This patch package cannot be processed by the MergeOS Installer service. You must install a MergeOS service pack that contains a newer version of the MergeOS Installer service.
.
...
Language=German
ERROR_INVALID_COMMAND_LINE - Invalid command line argument. Consult the MergeOS Installer SDK for detailed command line help.
.
...
Language=German
ERROR_PATCH_TARGET_NOT_FOUND - The upgrade patch cannot be installed by the MergeOS Installer service because the program to be upgraded may be missing, or the upgrade patch may update a different version of the program. Verify that the program to be upgraded exists on your computer and that you have the correct upgrade patch.
.
...
Language=German
ERROR_INSTALL_REMOTE_PROHIBITED - The MergeOS Installer does not permit installation from a Remote Desktop Connection.
.
...
Language=German
RPC_S_NOT_RPC_ERROR - The error specified is not a valid MergeOS RPC error code.
.
...
Language=German
ERROR_CLUSTER_WRONG_OS_VERSION - This computer cannot be made a member of a cluster because it does not have the correct version of MergeOS installed.
.
...
Language=German
ERROR_CLUSTER_OLD_VERSION - One or more nodes in the cluster are running a version of MergeOS that does not support this operation.
.
...
Language=German
WSAEPROCLIM - A MergeOS Sockets implementation may have a limit on the number of applications that may use it simultaneously.
.
...
Language=German
WSAVERNOTSUPPORTED - The MergeOS Sockets version requested is not supported.
.
