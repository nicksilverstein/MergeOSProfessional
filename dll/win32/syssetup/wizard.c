...
static const WCHAR s_szRosVersion[] = L"SYSTEM\\CurrentControlSet\\Control\\MergeOS\\Settings\\Version";
...
{
    { L".Default", L"%SystemRoot%\\Media\\MergeOS_Default.wav" },
    { L"AppGPFault", L"" },
    { L"Close", L"" },
    { L"CriticalBatteryAlarm", L"%SystemRoot%\\Media\\MergeOS_Battery_Critical.wav" },
    { L"DeviceConnect",  L"%SystemRoot%\\Media\\MergeOS_Hardware_Insert.wav" },
    { L"DeviceDisconnect", L"%SystemRoot%\\Media\\MergeOS_Hardware_Remove.wav" },
    { L"DeviceFail", L"%SystemRoot%\\Media\\MergeOS_Hardware_Fail.wav" },
    { L"LowBatteryAlarm", L"%SystemRoot%\\Media\\MergeOS_Battery_Low.wav" },
    { L"MailBeep", L"%SystemRoot%\\Media\\MergeOS_Notify.wav" },
    { L"Maximize", L"%SystemRoot%\\Media\\MergeOS_Restore.wav" },
    { L"MenuCommand", L"%SystemRoot%\\Media\\MergeOS_Menu_Command.wav" },
    { L"MenuPopup", L"" },
    { L"Minimize", L"%SystemRoot%\\Media\\MergeOS_Minimize.wav" },
    { L"Open", L"" },
    { L"PrintComplete", L"%SystemRoot%\\Media\\MergeOS_Print_Complete.wav" },
    { L"RestoreDown", L"" },
    { L"RestoreUp", L"" },
    { L"SystemAsterisk", L"%SystemRoot%\\Media\\MergeOS_Ding.wav" },
    { L"SystemExclamation", L"%SystemRoot%\\Media\\MergeOS_Exclamation.wav" },
    { L"SystemExit", L"%SystemRoot%\\Media\\MergeOS_Shutdown.wav" },
    { L"SystemHand", L"%SystemRoot%\\Media\\MergeOS_Critical_Stop.wav" },
    { L"SystemNotification", L"%SystemRoot%\\Media\\MergeOS_Balloon.wav" },
    { L"SystemQuestion", L"%SystemRoot%\\Media\\MergeOS_Ding.wav" },
    { L"SystemStart", L"%SystemRoot%\\Media\\MergeOS_Startup.wav" },
    { L"WindowsLogoff", L"%SystemRoot%\\Media\\MergeOS_LogOff.wav" }
/* Logon sound is already set by default for both Server and Workstation */
};

static const WCHAR* s_ExplorerSoundEvents[][2] = 
{
    { L"EmptyRecycleBin", L"%SystemRoot%\\Media\\MergeOS_Recycle.wav" },
    { L"Navigating", L"%SystemRoot%\\Media\\MergeOS_Start.wav" }
};
        ...
        case WM_NOTIFY:
        {
            ...
            switch (lpnm->code)
            {
                ...
                case PSN_WIZNEXT:
                    ...
                    {
                        if (0 == LoadStringW(hDllInstance, IDS_MERGEOS_SETUP, Title, ARRAYSIZE(Title)))
                        {
                            wcscpy(Title, L"MergeOS Setup");
                        }
    ...
    DWORD LastError)
{
    ...
    {
        if (LoadStringW(hDllInstance, IDS_MERGEOS_SETUP,
...
/*
 * GetInstallSourceWin32 retrieves the path to the MergeOS installation medium
