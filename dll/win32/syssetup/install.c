        ...
        case WM_INITDIALOG:
        {
            ...
            if (pDlgData)
            {
                ...
                pDlgData->hLogoBitmap = LoadImageW(hDllInstance,
                                                    MAKEINTRESOURCEW(IDB_MERGEOS), IMAGE_BITMAP,
                                                    0, 0, LR_DEFAULTCOLOR);
...
InstallMergeOS(VOID)
{
    ...
    LogItem(NULL, L"Installing MergeOS");
    ...
    LogItem(NULL, L"Installing MergeOS done");
 ...
 * to either 'InstallMergeOS' or 'InstallLiveCD'.
 */
INT
WINAPI
