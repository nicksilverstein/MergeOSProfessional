/*
 * PROJECT:         MergeOS PCI Bus Driver
...
PciIsDatacenter(VOID)
{
    ...
    else
    {
        ...
        UNIMPLEMENTED_FATAL("MergeOS doesn't use SetupDD for its installation program. Therefore this scenario must not happen!\n");
    }
