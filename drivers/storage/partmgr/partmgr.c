...
/* The Partition Manager Driver in MergeOS complements disk.sys/classpnp.sys drivers
 ...
 * exist in MergeOS. Thus handles some IOCTL_VOLUME_*, and IOCTL_MOUNTMGR_* IOCTLs.
 */
