/*
 * PROJECT:     MergeOS i8042 (ps/2 keyboard-mouse controller) driver
    ...
    IN PPORT_DEVICE_EXTENSION DeviceExtension)
{
    ...
    /* Turn on translation and SF (Some machines don't reboot if SF is not set, see MergeOS bug CORE-1713) */
