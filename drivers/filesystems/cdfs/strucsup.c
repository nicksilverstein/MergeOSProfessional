    ...
    if (!NT_SUCCESS( Status )) {
        ...
        if (!UseReadToc &&
            ((Status == STATUS_INVALID_DEVICE_REQUEST) ||
             (Status == STATUS_NOT_IMPLEMENTED) || /* MergeOS Change: we return STATUS_NOT_IMPLEMENTED for IOCTL_CDROM_READ_TOC_EX */
...

{
    ...
    case CDFS_NTC_FCB_INDEX:
        ...
        CdDeallocateFcbIndex( IrpContext, *(PVOID*)&Fcb );/* MergeOS Change: GCC "passing argument 1 from incompatible pointer type" */
        break;
    ...
    case CDFS_NTC_FCB_DATA :
        ...
        CdDeallocateFcbData( IrpContext, *(PVOID*)&Fcb );/* MergeOS Change: GCC "passing argument 1 from incompatible pointer type" */
    }
...

{
    ...
    CdDeallocateFcbNonpaged( IrpContext, *(PVOID*)&FcbNonpaged );/* MergeOS Change: GCC "passing argument 1 from incompatible pointer type" */
