...
typedef struct _VCB {
    ...
    ULONG VcbCleanup;
    __volatile LONG VcbReference; /* MergeOS Change: GCC 'pointer targets in passing argument 1 of 'InterlockedXxx' differ in signedness */
    __volatile LONG VcbUserReference; /* MergeOS Change: GCC 'pointer targets in passing argument 1 of 'InterlockedXxx' differ in signedness */
...
typedef struct _VOLUME_DEVICE_OBJECT {
    ...
    __volatile LONG PostedRequestCount; /* MergeOS Change: GCC "pointer targets in passing argument 1 of 'InterlockedDecrement' differ in signedness" */
...
typedef struct _FCB {
    ...
    ULONG FcbCleanup;
    __volatile LONG FcbReference; /* MergeOS Change: GCC 'pointer targets in passing argument 1 of 'InterlockedXxx' differ in signedness */
