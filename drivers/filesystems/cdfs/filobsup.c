...
#endif
    SetFlag( (*(PULONG_PTR)&FileObject->FsContext2), TypeOfOpen ); /* MergeOS Change: GCC "invalid lvalue in assignment" */
...
#pragma warning( suppress: 4213 )
#endif
        ClearFlag( (*(PULONG_PTR)Ccb), TYPE_OF_OPEN_MASK ); /* MergeOS Change: GCC "invalid lvalue in assignment" */
    }
