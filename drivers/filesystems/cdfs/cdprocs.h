...
static /* MergeOS Change: GCC "multiple definition" */
...
#define CdFreeIoContext(IO)     CdFreePool( (PVOID) &(IO) ) /* MergeOS Change: GCC "passing argument 1 from incompatible pointer type" */
...
//
/* MergeOS Change: GCC "passing argument 1 of CdFreePool from incompatible pointer type" */
