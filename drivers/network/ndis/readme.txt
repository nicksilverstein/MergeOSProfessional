...
-----------------------------------
 ...
 - from the top level mergeos directory:
    'make ndis'

 - make must be run from the top level mergeos directory to update the import
...
Building with Mingw32 and MergeOS include files:

    - Run "make ndis" FROM THE MergeOS ROOT DIRECTORY to build the library
