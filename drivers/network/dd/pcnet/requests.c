 ...
 *     borrowed very heavily from the MergeOS ne2000 driver by
 ...
 */
{
  ...
  switch (Oid)
    ...
    case OID_GEN_VENDOR_DESCRIPTION:
        {
          static UCHAR VendorDesc[] = "MergeOS Team";
          CopyFrom = VendorDesc;
