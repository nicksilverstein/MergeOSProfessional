/*
 * PROJECT:     MergeOS Console Text-Mode Device Driver
...
/*
 * (Adapted for MergeOS/Win2k3 from an original comment
 ...
 *
 * In MergeOS things are a little bit different. We want to have a functional
