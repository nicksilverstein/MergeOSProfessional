 ...
 *                                       class cannot be fixed until MergeOS
 ...
 *
 * Opengl icd are complete hacked in mergeos and are using own way, this need be rewriten and be setup with the correct syscall
 ...
 *
 * DirectX aka ReactX alot api that have been implement in mergeos win32k for ReactX shall move to a file call dxg.sys
