/*
 * PROJECT:          MergeOS Win32 Subsystem
...
* MergeOS specific: It is not in use yet?
*SystemResourcesList
*--*/
BOOLEAN
APIENTRY
...
*
* @remarks.
* MergeOS specific: Implementation is incomplete, I do not save the value into the hdev yet.
*
*--*/
DWORD_PTR
APIENTRY
...
{
    /* FIXME: MergeOS does not suport terminal server yet, we can not check if we got connections or not */
    UNIMPLEMENTED;
    return FALSE;
}
