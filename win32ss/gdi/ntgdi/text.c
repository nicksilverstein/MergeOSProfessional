/*
 * PROJECT:         MergeOS win32 kernel mode subsystem
...
/*
   ...
   It is needed because MergeOS does not support raster fonts now.
   After Raster Font support is added, then it can be removed.
   Find the current font's logfont for testing its lf.lfFaceName.

   The ftGdiGetTextMetricsW function currently in MergeOS will always return a Truetype font
