...
typedef struct
{
    ...
    HBITMAP   hBmpClose; /* MergeOS modification */
} MDICLIENTINFO;
...
#ifdef __MERGEOS__
	PostMessageA( hwnd, WM_MDICALCCHILDSCROLL, 0, 0 ); //// MergeOS: Post not send!
#else
...
void WINAPI CalcChildScroll( HWND hwnd, INT scroll )
{
    ...
    *
    * Apparently (in MergeOS at least) the rcClient returned by GetWindowInfo
