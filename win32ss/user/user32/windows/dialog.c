...
#define DF_DIALOGACTIVE 0x4000 // MergeOS
                                   ...
                                   BOOL unicode, HWND *modal_owner )
{
    ...
    else
    {
        ...
        else
        {
            ...
            //
            // MERGEOS : Need an owner to be passed!!!
            //
...
//// MergeOS see 43396, Fixes setting focus on Open and Close dialogs to the FileName edit control in OpenOffice.
//// This now breaks test_SaveRestoreFocus.
            //DEFDLG_SaveFocus( hwnd );
////
        }
//// MergeOS Rev 30613 & 30644
  ...
  LPARAM lParam)
{
    ...
    if(!(dlgInfo = DIALOG_get_info( hDlg, TRUE ))) return 0; //// MERGEOS : Always TRUE! See RealGetWindowClass.
...
/*
 * @implemented Modified for MergeOS. Do not Port Sync!!!
 */
BOOL
WINAPI
EndDialog(
...
{
	HWND hwndCtrl;
	if ( hDlg == HWND_TOPMOST || hDlg == HWND_BROADCAST ) return 0; // MergeOS
...
SetDlgItemTextA(
  ...
  LPCSTR lpString)
{
  HWND hwndCtrl = GetDlgItem( hDlg, nIDDlgItem ); // MergeOS Themes
