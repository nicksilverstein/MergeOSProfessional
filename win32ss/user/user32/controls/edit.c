...
typedef struct
{
	 ...
	 * IME Data
	 */
#ifndef __MERGEOS__ /* Rely on the composition window */
...
#ifdef __MERGEOS__
/* FIXME: What is this ? */
	    CHAR *textA = NULL; // MergeOS Hacked! r45670
	    //UINT countA = 0;
...
#ifndef __MERGEOS__ /* We don't use internal composition string. Rely on the composition window */
...
#ifdef __MERGEOS__
        /* MergeOS: check GetWindowLong in case es has been destroyed during processing */
