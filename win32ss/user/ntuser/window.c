...
////
//// MergeOS work around! Keep it the sames as in Combo.c and Controls.h
////
/* combo state struct */
typedef struct
{
...
////
//// MergeOS work around! Keep it the sames as in Listbox.c
////
/* Listbox structure */
typedef struct
{
...
NtUserDefSetText(HWND hWnd, PLARGE_STRING WindowText)
{
   ...
   // MergeOS uses Unicode and not mixed. Up/Down converting will take time.
