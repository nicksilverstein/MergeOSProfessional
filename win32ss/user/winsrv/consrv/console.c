 ...
 * PROJECT:         MergeOS Console Server DLL
...
// Adapted from mergeos/lib/rtl/unicode.c, RtlCreateUnicodeString line 2180
static BOOLEAN
...
// Adapted from mergeos/lib/rtl/unicode.c, RtlFreeUnicodeString line 431
static VOID
                  ...
                  IN PCSR_PROCESS ConsoleLeaderProcess)
{
    ...
    *NewConsole = NULL;
    ...
    if (ConsoleInfo->ConsoleTitle[0] == UNICODE_NULL)
    {
        ...
        {
            ConsoleCreateUnicodeString(&Console->Title, L"MergeOS Console");
        }
    }
    else
    {
        ...
        CONSOLE_GETLANGID, LangIdRequest)
{
    ...
    {
/** MergeOS-specific: do nothing if the code page is UTF-8. This will allow
 ** programs to naturally output in whatever current language they are. **/
    case CP_UTF8:
        return STATUS_NOT_SUPPORTED;
/** End MergeOS-specific **/
    case CP_JAPANESE:
