...
For information on how to compile and install the MergeOS Explorer please look at the FAQ web page:
...
Ideally, this would be incorporated into some other part of MergeOS, where
