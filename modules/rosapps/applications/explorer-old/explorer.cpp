...
void ExplorerGlobals::read_persistent()
{
    ...
    _cfg_dir.printf(TEXT("%s\\MergeOS"), (LPCTSTR)SpecialFolderFSPath(CSIDL_APPDATA,0));
            ...
            >
{
    ...
    ExplorerAboutDlg(HWND hwnd)
     :    super(hwnd)
    {
        SetWindowIcon(hwnd, IDI_MERGEOS);
    ...
    void Paint()
    {
        ...
        HICON hicon = (HICON) LoadImage(g_Globals._hInstance, MAKEINTRESOURCE(IDI_MERGEOS_BIG), IMAGE_ICON, 0, 0, LR_SHARED);
