...
/*		StartMenuFolders new_folders;
	...
	// browse menu
	  ...
	  case IDC_NETWORK:
#ifdef __MERGEOS__	///@todo to be removed when network browsing will be implemented in shell namespace
...
{
#ifndef __MERGEOS__	///@todo to be removed when SHFindFiles() will be implemented in shell32.dll
...
{
#ifndef __MERGEOS__	///@todo to be removed when SHFindComputer() will be implemented in shell32.dll
...
#if defined(ROSSHELL) || defined(__MERGEOS__)	// __MERGEOS__ to be removed when printers will be implemented
...
#if defined(ROSSHELL) || defined(__MERGEOS__)	// __MERGEOS__ to be removed when printer/network will be implemented
