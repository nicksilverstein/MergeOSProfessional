...
IntPrintUsage()
{
    cout << "rosautotest - MergeOS Automatic Testing Utility" << endl
         ...
         << "    /r           - Maintain information to resume from MergeOS crashes" << endl
         << "                   Can only be run under MergeOS and relies on sysreg2," << endl
