...
{
    {testLen, L"C:\\MergeOS", NULL, 0, 9, 9, TRUE, FALSE},
    ...
    {testBoth, L"C:\\MergeOS", L"", 0, -1, 0, FALSE, FALSE},
    {testBoth, L"C:\\MergeOS\\", L"C:\\MergeOS", 0, -1, 0, FALSE, FALSE},
    {testBoth, L"C:\\MergeOS\\", L"MergeOS", 0, -1, 0, FALSE, FALSE},
};
...
/* Static tests */
static const WCHAR wszMergeOS[] = L"C:\\MergeOS";
static const CHAR szMergeOS[] = "C:\\MergeOS";
...
{
    {wszMergeOS, wszMergeOS, wszMergeOS,
      szMergeOS,  szMergeOS,  szMergeOS},
    {wszMergeOS, wszMergeOS + 1, wszMergeOS,
      szMergeOS,  szMergeOS + 1,  szMergeOS},
    {wszMergeOS, wszMergeOS + 2, wszMergeOS + 1,
      szMergeOS,  szMergeOS + 2,  szMergeOS + 1},
    {wszMergeOS, wszMergeOS + 3, wszMergeOS + 2,
      szMergeOS,  szMergeOS + 3,  szMergeOS + 2},
    {wszMergeOS, wszMergeOS + 10, wszMergeOS + 9,
      szMergeOS,  szMergeOS + 10,  szMergeOS + 9},

    {wszMergeOS + 2, wszMergeOS, wszMergeOS,
      szMergeOS + 2,  szMergeOS,  szMergeOS},
    {wszMergeOS + 2, wszMergeOS + 1, wszMergeOS + 1,
      szMergeOS + 2,  szMergeOS + 1,  szMergeOS + 1},
    {wszMergeOS + 2, wszMergeOS + 2, wszMergeOS + 2,
      szMergeOS + 2,  szMergeOS + 2,  szMergeOS + 2},
    {wszMergeOS + 2, wszMergeOS + 3, wszMergeOS + 2,
      szMergeOS + 2,  szMergeOS + 3,  szMergeOS + 2},
    {wszMergeOS + 2, wszMergeOS + 4, wszMergeOS + 3,
      szMergeOS + 2,  szMergeOS + 4,  szMergeOS + 3},
...
{
    {wszMergeOS, wszMergeOS + 1,
      szMergeOS,  szMergeOS + 1},
    {wszMergeOS + 1, wszMergeOS + 2,
      szMergeOS + 1,  szMergeOS + 2},
    {wszMergeOS + 2, wszMergeOS + 3,
      szMergeOS + 2,  szMergeOS + 3},
    {wszMergeOS + 9, wszMergeOS + 10,
      szMergeOS + 9,  szMergeOS + 10},
    {wszMergeOS + 10, wszMergeOS + 10,
      szMergeOS + 10,  szMergeOS + 10},
...
{
    {wszMergeOS, NULL, NULL,
      szMergeOS, NULL, NULL, NULL,
     STATUS_SUCCESS},
    {NULL, NULL, NULL,
     NULL, NULL, NULL, NULL,
     STATUS_SUCCESS},
    {NULL, wszMergeOS, wszMergeOS - 1,
     NULL,  szMergeOS,  szMergeOS - 1, szMergeOS - 1,
     STATUS_SUCCESS},
    ...
    {wszMergeOS, INVALID_PTR, NULL,
      szMergeOS, INVALID_PTR, INVALID_PTR_OFF(-1) /* NULL on Win7 with updates */, NULL,
     STATUS_ACCESS_VIOLATION},
    {INVALID_PTR, INVALID_PTR, INVALID_PTR,
     INVALID_PTR, INVALID_PTR, INVALID_PTR, INVALID_PTR,
     STATUS_SUCCESS},
    {INVALID_PTR, wszMergeOS, wszMergeOS,
     INVALID_PTR,  szMergeOS,  szMergeOS, szMergeOS,
     STATUS_SUCCESS},
...
static void testCharPrev(void)
{
    ...
    if (INVALID_PTR < (PVOID)wszMergeOS)
    {
        ok(FALSE, "testCharPrev: unexpected INVALID PTR < wszMergeOS\n");
        return;
    }
    if (INVALID_PTR < (PVOID)szMergeOS)
    {
        ok(FALSE, "testCharPrev: unexpected INVALID PTR < szMergeOS\n");
        return;
    }
...
static void testCharNext(void)
{
    ...
    if (INVALID_PTR < (PVOID)wszMergeOS)
    {
        ok(FALSE, "testCharNext: unexpected INVALID PTR < wszMergeOS\n");
        return;
    }
    if (INVALID_PTR < (PVOID)szMergeOS)
    {
        ok(FALSE, "testCharNext: unexpected INVALID PTR < szMergeOS\n");
        return;
    }
