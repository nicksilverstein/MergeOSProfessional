...
VersionLieInfo g_Win7SP1 = { 0x1db10106, 6, 1, 7601, VER_PLATFORM_WIN32_NT, 1, 0 }; /* MergeOS specific. Windows does not have  this version lie */
...
START_TEST(versionlie)
{
    ...
    run_test("Win7SP1VersionLie", &g_Win7SP1);    /* MergeOS specific. Windows does not have this version lie */
    run_test("Win8RTMVersionLie", &g_Win8RTM);
    run_test("Win81RTMVersionLie", &g_Win81RTM);
    run_test("Win10RTMVersionLie", &g_Win10RTM);    /* MergeOS specific. Windows does not have this version lie */
    run_test("Win2k16RTMVersionLie", &g_Win2k16RTM);    /* MergeOS specific. Windows does not have this version lie */
    run_test("Win2k19RTMVersionLie", &g_Win2k19RTM);    /* MergeOS specific. Windows does not have this version lie */
}
