/*
 * PROJECT:         MergeOS kernel-mode tests
    ...
    _In_ PCWSTR SystemRootName)
{
    ...
    UNICODE_STRING SystemRootTemplate = RTL_CONSTANT_STRING(L"MergeOS");
...
TestRelativeNames(VOID)
{
    ...
    } Tests[] =
    {
        ...
        { NULL,                         L"C:\\MergeOS",                     TRUE,   STATUS_SUCCESS },
        { NULL,                         L"C:\\MergeOS\\",                   TRUE,   STATUS_SUCCESS },
        { NULL,                         L"C:\\MergeOS\\\\",                 TRUE,   STATUS_SUCCESS },
        { NULL,                         L"C:\\MergeOS\\\\\\",               TRUE,   STATUS_OBJECT_NAME_INVALID },
        { NULL,                         L"C:\\\\MergeOS",                   TRUE,   STATUS_SUCCESS },
        { NULL,                         L"C:\\\\MergeOS\\",                 TRUE,   STATUS_SUCCESS },
        { NULL,                         L"C:\\MergeOS\\explorer.exe",       FALSE,  STATUS_SUCCESS },
        { NULL,                         L"C:\\MergeOS\\\\explorer.exe",     FALSE,  STATUS_OBJECT_NAME_INVALID },
        { NULL,                         L"C:\\MergeOS\\explorer.exe\\",     FALSE,  STATUS_OBJECT_NAME_INVALID },
        { NULL,                         L"C:\\MergeOS\\explorer.exe\\file", FALSE,  STATUS_OBJECT_PATH_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\explorer.exe\\\\",   FALSE,  STATUS_OBJECT_NAME_INVALID },
        ...
        { NULL,                         L"C:\\MergeOS\\explorer.exe\\\\\\", TRUE,   STATUS_OBJECT_NAME_INVALID },
        { L"C:\\",                      L"",                                TRUE,   STATUS_SUCCESS },
        { L"C:\\",                      L"\\",                              TRUE,   STATUS_OBJECT_NAME_INVALID },
        { L"C:\\",                      L"MergeOS",                         TRUE,   STATUS_SUCCESS },
        { L"C:\\",                      L"\\MergeOS",                       TRUE,   STATUS_OBJECT_NAME_INVALID },
        { L"C:\\",                      L"MergeOS\\",                       TRUE,   STATUS_SUCCESS },
        { L"C:\\",                      L"\\MergeOS\\",                     TRUE,   STATUS_OBJECT_NAME_INVALID },
        { L"C:\\MergeOS",               L"",                                TRUE,   STATUS_SUCCESS },
        { L"C:\\MergeOS",               L"explorer.exe",                    FALSE,  STATUS_SUCCESS },
        { L"C:\\MergeOS\\explorer.exe", L"",                                FALSE,  STATUS_SUCCESS },
        { L"C:\\MergeOS\\explorer.exe", L"file",                            FALSE,  STATUS_OBJECT_PATH_NOT_FOUND },
        /* Let's try some nonexistent things */
        { NULL,                         L"C:\\MergeOS\\IDoNotExist",        FALSE,  STATUS_OBJECT_NAME_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\IDoNotExist\\file",  FALSE,  STATUS_OBJECT_PATH_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\IDoNotExist\\file?", FALSE,  STATUS_OBJECT_PATH_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\IDoNotExist\\file\\\\",TRUE,STATUS_OBJECT_PATH_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\IDoNotExist\\file\\\\\\",TRUE,STATUS_OBJECT_PATH_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\AmIInvalid?",        FALSE,  STATUS_OBJECT_NAME_INVALID },
        { NULL,                         L"C:\\MergeOS\\.",                  TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\..",                 TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\...",                TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\.\\system32",        TRUE,   STATUS_OBJECT_PATH_NOT_FOUND },
        { NULL,                         L"C:\\MergeOS\\..\\MergeOS",        TRUE,   STATUS_OBJECT_PATH_NOT_FOUND },
        { L"C:\\",                      L".",                               TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { L"C:\\",                      L"..",                              TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { L"C:\\",                      L"...",                             TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { L"C:\\",                      L".\\MergeOS",                      TRUE,   STATUS_OBJECT_PATH_NOT_FOUND },
        { L"C:\\",                      L"..\\MergeOS",                     TRUE,   STATUS_OBJECT_PATH_NOT_FOUND },
        { L"C:\\MergeOS",               L".",                               TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { L"C:\\MergeOS",               L"..",                              TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { L"C:\\MergeOS",               L"...",                             TRUE,   STATUS_OBJECT_NAME_NOT_FOUND },
        { L"C:\\MergeOS",               L".\\system32",                     TRUE,   STATUS_OBJECT_PATH_NOT_FOUND },
        { L"C:\\MergeOS",               L"..\\MergeOS",                     TRUE,   STATUS_OBJECT_PATH_NOT_FOUND },
        /* Volume open */
