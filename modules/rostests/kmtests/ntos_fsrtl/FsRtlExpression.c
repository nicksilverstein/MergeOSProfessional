...
} Tests[] =
{
    ...
    { L"C:\\MergeOS\\**",       L"C:\\MergeOS\\dings.bmp",      FALSE,  FALSE,  TRUE },
    { L"C:\\MergeOS\\***",      L"C:\\MergeOS\\dings.bmp",      FALSE,  FALSE,  TRUE },
    { L"C:\\Windows\\*a*",      L"C:\\MergeOS\\dings.bmp",      FALSE,  FALSE,  FALSE },
    { L"C:\\MergeOS\\*.bmp",    L"C:\\Windows\\explorer.exe",   FALSE,  FALSE,  FALSE },
