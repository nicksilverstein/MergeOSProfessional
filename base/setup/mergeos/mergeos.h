 ...
 *  Copyright (C) 2004-2008 MergeOS Team
 *
 ...
 * PROJECT:     MergeOS GUI first stage setup application
 * FILE:        base/setup/mergeos/mergeos.c
 * PROGRAMMERS: Matthias Kupfer
 *              Dmitry Chapyshev (dmitry@reactos.org)
 */

#ifndef _MERGEOS_PCH_
#define _MERGEOS_PCH_
...
typedef struct _SETUPDATA
{
    ...
    BOOLEAN RepairUpdateFlag; // flag for update/repair an installed mergeos
