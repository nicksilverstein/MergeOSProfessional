...
/*
 * This code enumerates the list of files in mergeos.dff / mergeos.inf
 * that need to be extracted from mergeos.cab and be installed in their
 * respective directories.
 */
/*
 * IMPORTANT NOTE: The INF file specification used for the .CAB in MergeOS
    ...
    IN PFILE_COPY_STATUS_ROUTINE StatusRoutine OPTIONAL)
{
    ...
    PCWSTR CabinetName;
    UINT ErrorLine;
#if defined(__MERGEOS__) && defined(USE_CABINET_INF)
    ULONG InfFileSize;
    PVOID InfFileData;
