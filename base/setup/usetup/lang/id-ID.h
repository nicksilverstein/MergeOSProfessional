...
{
    {
        4,
        3,
        " Penyetelan MergeOS " KERNEL_VERSION_STR " ",
    ...
    },
    {
        0,
        20,
        "Harap tunggu saat Penyetelan MergeOS menginisialisasi",
...
static MUI_ENTRY idIDWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Selamat datang di Penyetelan MergeOS",
    ...
    },
    {
        6,
        11,
        "Bagian dari penyetelan ini menyalin Sistem Operasi MergeOS ke",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Tekan ENTER untuk memasang atau meningkatkan MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Tekan R untuk memperbaiki instalasi MergeOS menggunakan Konsol Pemulihan.",
        "\x07  Tekan R untuk memperbaiki instalasi MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Tekan L untuk menampilkan Syarat dan Ketentuan Lisensi MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        23,
        "Untuk informasi lebih lanjut terkait MergeOS, mohon kunjungi:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "MergeOS saat ini dalam tahap Alpha, artinya belum lengkap fitur dan",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        12,
        "dalam pengembangan berat. MergeOS direkomendasikan hanya untuk",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "berkenan untuk menjalankan MergeOS pada perangkat keras murni.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Tekan ENTER untuk melanjutkan Penyetelan MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "Sistem MergeOS dilisensikan berdasarkan ketentuan",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Semua perangkat lunak yang menjadi bagian dari sistem MergeOS,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "Lisensi MergeOS hanya mencakup distribusi ke pihak ketiga.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License dengan MergeOS silahkan kunjungi",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan MergeOS masih dalam tahap pengembangan awal di mana masih",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan MergeOS dapat meningkatkan salah satu dari instalasi",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "MergeOS yang tersedia di bawah ini, atau, jika instalasi MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "MergeOS tidak terpasang sepenuhnya.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Komponen dasar MergeOS berhasil dipasang.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Tekan ENTER untuk memasang MergeOS pada partisi terpilih.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "menggunakan format yang tidak didukung oleh MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Agar instalasi MergeOS berhasil, program Penyetelan harus",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "asli setelah menyelesaikan instalasi MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "MergeOS) atau program lain yang disediakan oleh pabrik perangkat keras.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "komputer dari harddisk hingga Anda menyelesaikan Penyetelan MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan memasang berkas MergeOS pada partisi terpilih. Pilih",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "anda inginkan untuk memasang MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Harap tunggu sementara Penyetelan MergeOS menyalin Berkas ke",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan menpersiapkan komputer Anda untuk menyalin berkas MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR idIDErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "MergeOS tidak terpasang sepenuhnya pada komputer\n"
        "anda. Jika anda keluar sekarang, anda akan memulai\n"
        "lagi Penyetelan untuk memasang MergeOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Gagal membangun jalur instalasi untuk direktori instalasi MergeOS!\n"
        "ENTER = Mulai ulang komputer"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "Anda tidak dapat memasang MergeOS yang di dalamnya berisi direktori sumber instalasi!\n"
        "ENTER = Mulai ulang komputer"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Partisi yang dipilih tidak cukup besar untuk memasang MergeOS.\n"
...
MUI_STRING idIDStrings[] =
{
    ...
    "Pilihlah untuk memasang MergeOS pada partisi baru atau yang belum diformat."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "Partisi sistem ini belum diformat."},
    {STRING_NONFORMATTEDOTHERPART,
    "Partisi baru ini belum diformat."},
    {STRING_INSTALLONPART,
    "Penyetelan memasang MergeOS pada Partisi"},
    {STRING_CONTINUE,
    "ENTER = Lanjut"},
    {STRING_QUITCONTINUE,
    "F3 = Keluar  ENTER = Lanjut"},
