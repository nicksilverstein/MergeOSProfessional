...
{
    {
        4,
        3,
        " Instalaci\242n de MergeOS " KERNEL_VERSION_STR " ",
    ...
    },
    {
        0,
        20,
        "Por favor, espere a que la instalaci\242n de MergeOS se inicie",
...
static MUI_ENTRY esESWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bienvenido a la instalaci\242n de MergeOS",
    ...
    },
    {
        6,
        11,
        "Este es el primer paso de instalaci\242n, que copiar\240 MergeOS en",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Pulse INTRO para instalar o actualizar MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
//      "\x07  Pulse R para reparar una instalación de MergeOS usando la Consola de Recuperación.",
        "\x07  Pulse R para reparar MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        21,
        "\x07  Pulse F3 para salir sin instalar MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Para m\240s informaci\242n sobre MergeOS, visite la Web:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESIntroPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Situaci\242n de la Versi\242n de MergeOS",
        TEXT_STYLE_HIGHLIGHT,
        TEXT_ID_STATIC
    },
    {
        6,
        11,
        "MergeOS est\240 en fase Alpha, lo que significa que a\243n no est\240",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "en caso de que uses MergeOS en hardware real.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Pulse INTRO para continuar la instalaci\242n de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "MergeOS se distribuye bajo los T\202rminos y Condiciones de",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Todo el software que forma parte del sistema MergeOS est\240,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "La licencia de MergeOS cubre solo la distribuci\242n a terceros.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License con MergeOS visite:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "La instalaci\242n de MergeOS se encuentra en una fase preliminar.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "El instalador puede actualizar una de las versiones de MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "listadas a continuaci\242n o, si la instalaci\242n de MergeOS est\240 da\244ada,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "MergeOS no ha sido instalado completamente.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Los componentes b\240sicos de MergeOS han sido instalados correctamente.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Pulse INTRO para instalar MergeOS en la Partici\242n seleccionada.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "usa un formato que MergeOS no puede gestionar.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Para poder instalar correctamente MergeOS, el instalador deber\240 cambiar",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "original una vez haya finalizado la instalaci\242n de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "dispositivos, software, sistemas de arranque de SO (como MergeOS) o",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "equipo desde ese disco duro hasta que termine de instalar MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "Seleccione el directorio donde quiere instalar MergeOS:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Por favor, espere mientras el Instalador de MergeOS copia",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
        0,
        13,
        "los archivos en el directorio de MergeOS.",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY esESPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "El instalador se prepara para copiar los archivos de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR esESErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "MergeOS no est\240 completamente instalado en su\n"
        "equipo. Si cierra ahora el Instalador, necesitar\240\n"
        "ejecutarlo otra vez para instalar MergeOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "\255Error creando las rutas de instalaci\242n para el directorio de MergeOS!\n"
        "INTRO = Reiniciar el equipo"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "\255No puede instalar MergeOS dentro del directorio fuente!\n"
        "INTRO = Reiniciar el equipo"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "instalar MergeOS. Se necesita una partici\242n de al menos %lu MB.\n"
        "\n"
        "  * Pulse una tecla para continuar.",
        NULL
    },
...
MUI_STRING esESStrings[] =
{
    ...
    "Ha elegido instalar MergeOS en una nueva Partici\242n o en una Partici\242n sin formato."},
    ...
    "El instalador est\240 instalando MergeOS en la Partici\242n"},
    {STRING_CONTINUE,
    "INTRO = Continuar"},
    {STRING_QUITCONTINUE,
    "F3 = Salir  INTRO = Continuar"},
