...
static MUI_ENTRY ptPTSetupInitPageEntries[] =
{
    ...
    },
    {
        0,
        20,
        "Por favor aguarde enquanto o Instalador do MergeOS inicializa",
...
static MUI_ENTRY ptPTWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bem-vindo ao assist\210nte de instala\207\306o do MergeOS.",
    ...
    },
    {
        6,
        11,
        "Esta fase da instala\207\306o prepara o MergeOS para ser",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Pressione ENTER para instalar ou actualizar o MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        23,
        "Para mais informa\207\344es sobre o MergeOS, visite o s\241tio:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "O MergeOS est\240 em est\240gio Alpha, o que significa que n\306o est\240 completo",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "secund\240rio se pretende executar o MergeOS em hardware real.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Pressione ENTER para continuar a instala\207\306o do MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Pressione F3 para terminar sem instalar o MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTLicensePageEntries[] =
{
    ...
    },
    {
        8,
        11,
        "Todo o software que faz parte do sistema MergeOS \202 portanto,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "A licen\207a do MergeOS abrange apenas a distribui\207\306o a terceiros.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Com o Instalador do MergeOS pode actualizar uma das instala\207\344es",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "dispon\241veis listadas abaixo, ou, se tem uma instala\207\306o do MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Para configurar o MergeOS no item seleccionado, pressione ENTER.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "formato n\306o suportado pelo MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Para instalar o MergeOS com sucesso, o instalador deve alterar",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "ap\242s a instala\207\306o do MergeOS ser concluida.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "(MergeOS) ou outro e programas fornecidos pelo fabricante do hardware.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "computador pelo disco r\241gido at\202 concluir a instala\207\306o do MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "Seleccione o direct\242rio onde deseja que o MergeOS seja instalado:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "o texto e escreva o nome do direct\242rio onde deseja que o MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR ptPTErrorEntries[] =
{
    ...
    },
    {
        ...
        "A parti\207\306o selecionada n\306o \202 grande o suficiente para instalar o MergeOS.\n"
...
//    "Voc\210 solicitou a cria\207\306o de uma nova parti\207\306o em"},
    ...
    "Solicitou instalar o MergeOS numa parti\207\306o nova ou sem formato."},
