...
{
    {
        4,
        3,
        " MergeOS " KERNEL_VERSION_STR " diegimo programa ",
...
static MUI_ENTRY ltLTWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Jus sveikina MergeOS diegimo programa",
    ...
    },
    {
        6,
        11,
        "\276i diegimo dalis nukopijuos MergeOS operacin\323s sistemos bylas \324 j\327s\326",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "\x07  Spauskite R, jei norite taisyti MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Spauskite L, jei norite pamatyti MergeOS licencijos s\320lygas.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Spauskite F3, jei norite u\330daryti MergeOS diegimo program\320.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Nor\323dami gauti daugiau informacijos apie MergeOS, aplankykite:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "MergeOS Setup is in an early development phase. It does not yet",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "MergeOS is not completely installed.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "The basic components of MergeOS have been installed successfully.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Press ENTER to install MergeOS onto the selected partition.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installs MergeOS files onto the selected partition. Choose a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "directory where you want MergeOS to be installed:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "characters and then type the directory where you want MergeOS to",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Please wait while MergeOS Setup copies files to your MergeOS",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup prepares your computer for copying the MergeOS files.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR ltLTErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "MergeOS is not completely installed on your\n"
        "computer. If you quit Setup now, you will need to\n"
        "run Setup again to install MergeOS.\n"
        "\n"
...
MUI_STRING ltLTStrings[] =
{
    ...
    "You chose to install MergeOS on a new or unformatted Partition."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "The system partition is not formatted yet."},
    {STRING_NONFORMATTEDOTHERPART,
    "The new partition is not formatted yet."},
    {STRING_INSTALLONPART,
    "Setup installs MergeOS onto Partition"},
    {STRING_CONTINUE,
    "ENTER = Continue"},
    {STRING_QUITCONTINUE,
    "F3 = Quit  ENTER = Continue"},
