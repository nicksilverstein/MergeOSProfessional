...
static MUI_ENTRY deDESetupInitPageEntries[] =
{
    ...
    },
    {
        0,
        20,
        "Bitte warten Sie w\204hrend das MergeOS Setup startet",
...
static MUI_ENTRY deDEWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "Dieser Teil des Setups kopiert das MergeOS-Betriebssystem auf Ihren",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Dr\201cken Sie ENTER, um MergeOS zu installieren / aktualisieren.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
        "\x07  Dr\201cken Sie R, um MergeOS zu reparieren. (Wiederherstellungskonsole)",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Dr\201cken Sie L, um das Lizenzabkommen von MergeOS zu lesen.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDEIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "MergeOS befindet sich noch im Alpha Stadium. Noch sind nicht alle",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "\x07  Dr\201cken Sie ENTER, um das MergeOS Setup fortzusetzen.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Dr\201cken Sie F3, um abzubrechen ohne MergeOS zu installieren.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDELicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "MergeOS ist unter den Bedingungen der GNU General Public License",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        9,
        "lizenziert. Einige Teile von MergeOS stehen unter dazu kompatiblen",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Alle Softwarebestandteile in MergeOS sind daher unter der",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "MergeOS ist freie Software. Die Ver\224ffentlichung dieses Programms",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        23,
        "zusammen mit MergeOS erhalten haben.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDERepairPageEntries[] =
{
    ...
    },
    {
        8,
        16,
        "\x07  Dr\201cken Sie U, um MergeOS zu aktualisieren.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDEUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Das MergeOS Setup kann eine der unten aufgef\201hrten Installationen",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        10,
        "eine bestehende MergeOS Installation zu reparieren.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDEQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "MergeOS wurde nicht vollst\204ndig installiert.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDESuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Die Grundkomponenten von MergeOS wurden erfolgreich installiert.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDEChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "verwendet eine von MergeOS nicht unterst\201tzte Formatierung.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Um MergeOS installieren zu k\224nnen, muss das Setup Programm",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "nachdem das MergeOS Setup abgeschlossen wurde.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY deDEInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "W\204hlen Sie ein Installationsverzeichnis f\201r MergeOS:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR deDEErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "MergeOS wurde nicht vollst\204ndig auf Ihrem System installiert.\n"
        "Wenn Sie die Installation jetzt beenden, m\201ssen Sie diese\n"
        "erneut starten, um MergeOS zu installieren.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Die Installationspfade f\201r das MergeOS Installationsverzeichnis konnten nicht erstellt werden!\n"
        "ENTER = Computer neu starten"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "MergeOS kann nicht in dasselbe Verzeichnis installiert werden, in dem die Installationsquellen liegen!\n"
        "ENTER = Computer neu starten"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Die gew\204hlte Partition ist nicht gro\341 genug, um MergeOS zu installieren.\n"
...
MUI_STRING deDEStrings[] =
{
    ...
    "Sie wollen MergeOS auf einer neuen/unformatierten Partition installieren."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "Die Systempartition ist noch nicht formartiert."},
    {STRING_NONFORMATTEDOTHERPART,
    "Die neue Partition ist noch nicht formatiert."},
    {STRING_INSTALLONPART,
    "MergeOS wird auf dieser Partition installiert."},
    {STRING_CONTINUE,
    "ENTER = Fortsetzen"},
    {STRING_QUITCONTINUE,
    "F3 = Beenden   ENTER = Fortsetzen"},
