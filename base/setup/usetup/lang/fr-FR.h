...
{
    {
        4,
        3,
        " Installation de MergeOS " KERNEL_VERSION_STR " ",
    ...
    },
    {
        0,
        20,
        "Veuillez patienter pendant que le programme d'installation de MergeOS",
...
static MUI_ENTRY frFRWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bienvenue dans l'installation de MergeOS",
    ...
    },
    {
        6,
        11,
        "Cette partie de l'installation copie le Syst\212me d'Exploitation MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Appuyer sur ENTR\220E pour installer ou mettre \205 jour MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
        "\x07  Appuyer sur R pour r\202parer MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Appuyer sur L pour les Termes et Conditions de Licence MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Appuyer sur F3 pour quitter sans installer MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Pour plus d'informations sur MergeOS, veuiller visiter :",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "MergeOS est en version Alpha, ce qui signifie qu'il n'est pas complet",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "si vous souhaitez utiliser MergeOS sur du mat\202riel.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Appuyez sur ENTR\220E pour continuer l'installation de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Appuyez sur F3 pour quitter sans installer MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "Le syst\212me MergeOS est distribu\202 sous les termes de",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Tout le logiciel constituant le syst\212me MergeOS est",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "La licence de MergeOS ne couvre que la distribution",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        20,
        "GNU General Public License avec MergeOS veuillez visiter",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "L'installation de MergeOS est en phase de d\202veloppement.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Le programme d'installation de MergeOS peut mettre \205 jour l'une des",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "installations de MergeOS list\202es ci-dessous, ou bien, si l'une d'elles",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "MergeOS n'est pas compl\212tement install\202.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Les composants standards de MergeOS ont \202t\202 install\202s avec succ\212s.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Appuyer sur ENTR\220E pour installer MergeOS sur la partition choisie.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "emploie un format qui n'est pas support\202 par MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Afin de pouvoir installer MergeOS avec succ\212s, MergeOS Setup doit changer",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "d'origine apr\212s la fin de l'installation de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "d'exploitation (comme MergeOS) ou d'autres programmes fournis par le",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        19,
        "finissiez l'installation de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installe les fichiers de MergeOS sur la partition s\202lectionn\202e.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "Choisissez un repertoire o\227 vous voulez que MergeOS soit install\202 :",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRFileCopyEntries[] =
{
    ...
    },
    {
        11,
        12,
        "Patientez pendant que MergeOS Setup copie les fichiers",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        15,
        13,
        "dans le r\202pertoire d'installation de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY frFRPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup pr\202pare votre ordinateur pour copier les fichiers de MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR frFRErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "MergeOS n'est pas compl\212tement install\202 sur votre\n"
        "ordinateur. Si vous quittez Setup maintenant, vous devrez\n"
        "lancer Setup de nouveau pour installer MergeOS.\n"
        "\n"
