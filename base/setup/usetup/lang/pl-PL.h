 ...
 *      Use MergeOS forum PM or IRC to contact me
 *      https://reactos.org/
 *      IRC: irc.freenode.net #mergeos-pl;
...
{
    {
        4,
        3,
        " Instalator MergeOS " KERNEL_VERSION_STR " ",
    ...
    },
    {
        0,
        20,
        "Poczekaj, a\276 uruchomi si\251 Instalator systemu MergeOS",
...
static MUI_ENTRY plPLWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Witamy w programie instalacyjnym systemu MergeOS",
    ...
    },
    {
        8,
        15,
        "\x07  Naci\230nij ENTER, aby zainstalowa\206 lub uaktualni\206 system MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
        "\x07  Naci\230nij R, aby naprawi\206 istniej\245c\245 instalacj\251 systemu MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Naci\230nij L, aby zapozna\206 si\251 z licencj\245 systemu MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Naci\230nij F3, aby wyj\230\206 bez instalacji systemu MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Wi\251cej informacji o systemie MergeOS mo\276na znale\253\206 na stronie:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "System MergeOS jest w fazie Alpha, co oznacza, \276e jest niekompletny",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "je\230li pr\242bujesz uruchomi\206 system MergeOS poza maszyn\245 wirtualn\245.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Naci\230nij ENTER, aby zainstalowa\206 system MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "System MergeOS jest licencjonowany na warunkach licencji",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "oprogramowanie, b\251d\245ce cz\251\230ci\245 systemu MergeOS podlega wi\251c",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        16,
        "b\245d\253 mi\251dzynarodowego. Licencja systemu MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU GPL wraz z systemem MergeOS, prosimy odwiedzi\206 stron\251:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalator systemu MergeOS wci\245\276 jest we wczesnej fazie rozwoju. Nadal nie",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalator mo\276e uaktualni\206 jedn\245 z poni\276szych instalacji systemu MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "Je\230li instalacja systemu MergeOS jest uszkodzona, instalator mo\276e",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLComputerPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Aby zmieni\206 typ komputera, na kt\242rym chcesz zainstalowa\206 system MergeOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLFlushPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "System MergeOS sprawdza, czy dane s\245 poprawnie zapisane na dysku.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "System MergeOS nie zosta\210 zainstalowany na tym komputerze.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Podstawowe sk\210adniki systemu MergeOS zosta\210y zainstalowane.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLBootPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalator systemu MergeOS nie mo\276e zainstalowa\206",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Naci\230nij ENTER, by zainstalowa\206 system MergeOS na wybranej partycji.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "u\276ywa formatu nie obs\210ugiwanego przez system MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Aby pomy\230lnie zainstalowa\206 system MergeOS, Instalator musi zmieni\206",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "systemowej do poprzednej po zako\344czeniu instalacji systemu MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "MergeOS) i inne programy dostarczane przez producent\242w.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "twardego do czasu zako\344czenia instalacji systemu MergeOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "katalog, do kt\242rego chcesz zainstalowa\206 system MergeOS:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY plPLFileCopyEntries[] =
{
    ...
    },
    {
        11,
        12,
        "Prosz\251 czeka\206, Instalator systemu MergeOS kopiuje pliki do wybranego",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR plPLErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "System MergeOS nie zosta\210 w pe\210ni zainstalowany na twoim\n"
        "komputerze. Je\230li wyjdziesz teraz, trzeba b\251dzie\n"
        "ponownie uruchomi\206 instalatora, by zainstalowa\206 system MergeOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Nie mo\276na utworzy\206 scie\276ek instalacji dla katalogu instalacji systemu MergeOS!\n"
    ...
    {
        // ERROR_SOURCE_DIR
        "Nie mo\276na zainstalowa\206 systemu MergeOS w katalogu \253r\242d\210owym instalacji!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Wybrana partycja nie jest wystarczaj\245co du\276a, aby zainstalowa\206 system MergeOS.\n"
...
MUI_STRING plPLStrings[] =
{
    ...
    "Mo\276esz zainstalowa\206 system MergeOS na nowej lub niesformatowanej partycji."},
