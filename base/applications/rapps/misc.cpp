...
InitLogs()
{
    ...
    if (key.Create(
            HKEY_LOCAL_MACHINE,
            L"SYSTEM\\CurrentControlSet\\Services\\EventLog\\Application\\MergeOS Application Manager", REG_NONE,
    ...
    {
        hLog = RegisterEventSourceW(NULL, L"MergeOS Application Manager");
    }
}
