          ...
          int nCmdShow)
{
    ...
    LoadString(hInstance, IDC_MERGEOS_SNDREC32, szWindowClass, MAX_LOADSTRING);
    ...
    hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MERGEOS_SNDREC32));
        ...
        case WM_COMMAND:
            ...
            switch (wmId)
            {
                ...
                case ID_ABOUT:
                    ...
                    hIcon = LoadIconW(hInst, MAKEINTRESOURCEW(IDI_MERGEOS_SNDREC32));
