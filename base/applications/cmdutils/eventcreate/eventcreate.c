 ...
 * PROJECT:         MergeOS EventCreate Command
 ...
 *    large file.
 *
 *    For MergeOS I want to have a compromise between disk space and usage
 ...
 *
 * MergeOS' EventCreate.exe command uses the same limits as Powershell.
 */
    ...
    IN LPCWSTR EventLogSource)
{
     ...
     * - In case of success, try to replace the MergeOS installation path
...
int wmain(int argc, WCHAR* argv[])
{
    ...
    OPTION Options[] =
    {
        ...
        /* Event category (MergeOS additional option) */
