MergeOS command line interpreter CMD
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The MergeOS command line interpreter CMD is derived from FreeCOM, the
...
Compiling
~~~~~~~~~
ROS cmd used to depend on __MERGEOS__ to provide two different ways to build cmd.  There is still code left in it for this but...  The __MERGEOS__ = 0 has not been develped, maintained.  And therefore it does not even compile anymore.  __MERGEOS__ = 1 works fine on both windows(nt). and someday i plan to remove all the __MERGEOS__ = 0.
...
Please report bugs to MergeOS team <ros-dev@reactos.org> or to JIRA at www.reactos.org
