/*
 * PROJECT:     MergeOS Service Control Manager
...
/* Defined in include/mergeos/services/services.h */
...
CheckForLiveCD(VOID)
{
    ...
    {
        DPRINT1("MergeOS Setup currently in progress!\n");
...
//    ScmInitThreadManager();
    ...
    /* Register the Service Control Manager process with the MergeOS Subsystem */
