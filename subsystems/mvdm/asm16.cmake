...
function(add_asm16_bin _target _binary_file _base_address)
    ...
    add_custom_command(
        OUTPUT ${_object_file}
        COMMAND ${CMAKE_ASM_COMPILER} -x assembler-with-cpp -o ${_object_file} -I${MERGEOS_SOURCE_DIR}/sdk/include/asm -I${MERGEOS_BINARY_DIR}/sdk/include/asm ${_directory_includes} ${_source_file_defines} ${_directory_defines} -D__ASM__ -c ${_concatenated_asm_file}
...
function(add_asm16_bin _target _binary_file _base_address)
    ...
    add_custom_command(
        ...
        #COMMAND ${CMAKE_C_COMPILER} /nologo ${_no_std_includes_flag} /I${MERGEOS_SOURCE_DIR}/sdk/include/asm /I${MERGEOS_BINARY_DIR}/sdk/include/asm ${_directory_includes} ${_source_file_defines} ${_directory_defines} /D__ASM__ /D_USE_ML /EP /c ${_concatenated_asm_file} > ${_preprocessed_asm_file}
        COMMAND cl /nologo /X /I${MERGEOS_SOURCE_DIR}/sdk/include/asm /I${MERGEOS_BINARY_DIR}/sdk/include/asm ${_directory_includes} ${_source_file_defines} ${_directory_defines} /D__ASM__ /D_USE_ML /EP /c ${_concatenated_asm_file} > ${_preprocessed_asm_file}
        DEPENDS ${_concatenated_asm_file})
