 ...
 */
static const CHAR BiosCopyright[] = "0000000 NTVDM IBM COMPATIBLE 486 BIOS COPYRIGHT (C) MergeOS Team 1996-"COPYRIGHT_YEAR;
static const CHAR BiosVersion[]   = "MergeOS NTVDM 32-bit BIOS Version "KERNEL_VERSION_STR"\0"
