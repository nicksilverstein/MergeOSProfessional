...
{
    DPRINT1("-----------------------------------------------------\n");
    DPRINT1("MergeOS " KERNEL_VERSION_STR " (Build " KERNEL_VERSION_BUILD_STR ") (Commit " KERNEL_VERSION_COMMIT_HASH ")\n");
    ...
    _In_opt_ PLOADER_PARAMETER_BLOCK LoaderBlock)
{
    ...
    if (EnableKd && (NT_SUCCESS(KdDebuggerInitialize0(LoaderBlock))))
    {
        ...
        /* Display separator + MergeOS version at start of the debug log */
