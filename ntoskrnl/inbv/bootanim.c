...
/*
 * MergeOS uses the same boot screen for all the products.
 *
 * Enable this define when MergeOS will have different SKUs
 ...
 * - PltRotBarStatus == 1, do palette fading-in (done elsewhere in MergeOS);
    ...
    _In_ BOOLEAN TextMode)
{
    ...
    else
    {
         ...
         * to show that MergeOS can be still alive when the bar does not
         * appear to progress.
         */
