/*
 * Copyright (C) 1998-2005 MergeOS Team (and the authors from the programmers section)
 *
...
l_ReadHeaderFromFile:
    ...
    case IMAGE_NT_OPTIONAL_HDR32_MAGIC:
    {
        ...
        if (RTL_CONTAINS_FIELD(piohOptHeader, cbOptHeaderSize, DllCharacteristics))
        {
             ...
             * but honestly that's not tested. It will also break them when running no MergeOS once we implement
