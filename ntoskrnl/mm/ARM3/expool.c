 ...
 * against MergeOS to warrant the performance hit.
 *
                     ...
                     IN POOL_TYPE PoolType)
{
    ...
    // some expansion. This path is not yet supported in MergeOS and so we'll
    // ignore the tag
    //
                     ...
                     IN POOL_TYPE PoolType)
{
    ...
    //
    // ASSERT on MergeOS features not yet supported
    //
                           ...
                           IN PVOID PoolLock)
{
    ...
    //
    // Note that MergeOS does not support Session Pool Yet
    //
                        ...
                        IN PVOID SystemArgument2)
{
    ...
    if (KeSignalCallDpcSynchronize(SystemArgument2))
    {
        ...
        //
        // This is here because MergeOS does not yet support expansion
        //
