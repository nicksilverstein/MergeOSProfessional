                        ...
                        IN ULONG Protect)
{
    ...
    //
    // This is a specific MergeOS check because we only use normal VADs
    //
                    ...
                    IN ULONG FreeType)
{
    ...
    //
    // Finally, make sure there is a MergeOS Mm MEMORY_AREA for this allocation
        ...
        else
        {
            ...
            if ((StartingAddress >> PAGE_SHIFT) == Vad->StartingVpn)
            {
                ...
                else
                {
                    ...
                    // For MergeOS: shrink the corresponding memory area
            ...
            else
            {
                ...
                else
                {
                    ...
                    // MergeOS: This will take care of creating a second MEMORY_AREA.
                    //
