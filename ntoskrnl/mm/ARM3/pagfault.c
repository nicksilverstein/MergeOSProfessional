                      ...
                      OUT PMMVAD *ProtoVad)
{
    ...
    *ProtoVad = NULL;
    ...
    if (VirtualAddress <= MM_HIGHEST_USER_ADDRESS)
    {
        ...
        {
            /* MergeOS does not supoprt these VADs yet */
    ...
    {
        /* MergeOS does not have an image list yet, so bail out to failure case */
                ...
                IN PMMVAD Vad)
{
    ...
    if (PointerProtoPte)
    {
        ...
        else
        {
            ...
            {
                /* One day, MergeOS will cluster faults */
            ...
            while (TRUE)
            {
                         ...
                         (TempPte.u.Soft.Transition == 1))
                {
                    ...
                    /* Should not yet happen in MergeOS */
                    ASSERT(Pfn1->u3.e1.ReadInProgress == 0);
                    ASSERT(Pfn1->u4.InPageError == 0);
                 ...
                 IN PVOID TrapInformation)
{
    ...
    if (OldIrql > APC_LEVEL)
    {
        ...
        /* Not yet implemented in MergeOS */
