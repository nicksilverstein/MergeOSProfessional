...
//
// By default, it is a 16MB region, but we hack it to be 32MB for MergeOS
//
...
//
// Unlike the old MergeOS Memory Manager, ARM³ (and Windows) does not keep track
...
MiBuildPagedPool(VOID)
{
    ...
    // page directory array in the old MergeOS Mm is used (but in a less hacky
    // way).
    //
