...
MergeOS™ is an Open Source effort to develop a quality operating system that is
...
MergeOS has always intended to work with the WINE project to share as much
...
The MergeOS project, although currently focused on Windows Server 2003
...
The Windows NT architecture allows for subsystems, as does the MergeOS
architecture. A subsystem is an implementation of the APIs of another
operating system, allowing MergeOS to run applications from other systems.
...
Yes we are.
All the code of MergeOS has been written from scratch by our developers.
...
MergeOS - amongst other topics. Contributors to the project are always welcome.
...
In addition, the MergeOS forum: https://reactos.org/forum
