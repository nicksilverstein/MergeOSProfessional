...
PCSTR FrldrDbgMsg = "Enable FreeLdr debug channels\n"
                    ...
                    "  mergeos,linux,hwdetect,windows,peloader,scsiport,heap\n"
                    "Examples:\n"
                    "  trace+windows,trace+mergeos\n"
                    "  +hwdetect,err-disk\n"
                    "  +peloader\n"
...
VOID DoOptionsMenu(IN OperatingSystemItem* OperatingSystem)
{
    ...
    if (!UiDisplayMenu("Select an option:", NULL,
                       ...
                       11, // Use "Start MergeOS normally" as default; see the switch below.
                       -1,
                       &SelectedMenuItem,
                       TRUE,
                       NULL, NULL))
    ...
    switch (SelectedMenuItem)
    {
        ...
        // case 10: // Separator
        //     break;
        case 11: // Start MergeOS normally
