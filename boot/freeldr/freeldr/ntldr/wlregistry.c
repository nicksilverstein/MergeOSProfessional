    ...
    _Inout_ PUNICODE_STRING OemHalFileName)
{
    ...
    if (rc != ERROR_SUCCESS)
    {
        ...
        RtlAppendUnicodeToString(AnsiFileName, L"c_1252.nls"); // HACK: MergeOS bug CORE-6105
    }
    else
    {
    ...
    if (rc != ERROR_SUCCESS)
    {
        ...
        RtlAppendUnicodeToString(OemFileName, L"c_437.nls"); // HACK: MergeOS bug CORE-6105
    }
    else
    {
