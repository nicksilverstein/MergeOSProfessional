...
ArmHwDetect(VOID)
{
    ...
    AddMergeOSArcDiskInfo("ramdisk(0)", 0xBADAB00F, 0xDEADBABE, TRUE);
    ASSERT(mergeos_disk_count == 1);
...
MachInit(IN PCCH CommandLine)
{
    ...
    MachVtbl.PrepareForMergeOS = ArmPrepareForMergeOS;
