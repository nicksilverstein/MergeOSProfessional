/*
 * PROJECT:         MergeOS Boot Loader (FreeLDR)
...
ULONG mergeos_disk_count = 0;
ARC_DISK_SIGNATURE_EX mergeos_arc_disk_info[32];
...
VOID
AddMergeOSArcDiskInfo(
    IN PSTR ArcName,
    IN ULONG Signature,
    IN ULONG Checksum,
    IN BOOLEAN ValidPartitionTable)
{
    ASSERT(mergeos_disk_count < sizeof(mergeos_arc_disk_info)/sizeof(mergeos_arc_disk_info[0]));

    /* Fill out the ARC disk block */

    mergeos_arc_disk_info[mergeos_disk_count].DiskSignature.Signature = Signature;
    mergeos_arc_disk_info[mergeos_disk_count].DiskSignature.CheckSum = Checksum;
    mergeos_arc_disk_info[mergeos_disk_count].DiskSignature.ValidPartitionTable = ValidPartitionTable;

    strcpy(mergeos_arc_disk_info[mergeos_disk_count].ArcName, ArcName);
    mergeos_arc_disk_info[mergeos_disk_count].DiskSignature.ArcName =
        mergeos_arc_disk_info[mergeos_disk_count].ArcName;
