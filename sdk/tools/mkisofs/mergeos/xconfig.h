 ...
 * For the MergeOS Build System, we provide a written version of this file with sufficient
...
#define HOST_CPU "MergeOS"
#define HOST_VENDOR KERNEL_VERSION_BUILD_STR
#define HOST_OS MERGEOS_COMPILER_NAME "-" MERGEOS_COMPILER_VERSION
