 ...
 * Released under the GNU GPL for the MergeOS project
 *
 * This program can be used to spy on a named pipe in Windows NT(+)
 * or MergeOS.  It is particularly intended to be used for
 ...
 * NOTE:
 *
 * This program hasn't really been tested against MergeOS, and has only
