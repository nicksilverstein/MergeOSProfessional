...
function(CreateBootSectorTarget _target_name _asm_file _binary_file _base_address)
    ...
    add_custom_command(
        OUTPUT ${_temp_file}
        COMMAND ${CMAKE_C_COMPILER} /nologo ${_no_std_includes_flag} /I${MERGEOS_SOURCE_DIR}/sdk/include/asm /I${MERGEOS_BINARY_DIR}/sdk/include/asm ${_includes} ${_defines} /D__ASM__ /D_USE_ML /EP /c ${_asm_file} > ${_temp_file}
        DEPENDS ${_asm_file})
    ...
    foreach(_source_file ${ARGN})
        ...
        if (("${_extension}" STREQUAL ".asm") OR ("${_extension}" STREQUAL ".inc"))
            ...
            add_custom_command(
                ...
                COMMAND cl /nologo /X /I${MERGEOS_SOURCE_DIR}/sdk/include/asm /I${MERGEOS_BINARY_DIR}/sdk/include/asm ${_directory_includes} ${_source_file_defines} ${_directory_defines} /D__ASM__ /D_USE_ML /EP /c ${_source_file_full_path} > ${_preprocessed_asm_file}
