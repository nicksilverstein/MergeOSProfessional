...
function(add_dependency_node _node)
    if(GENERATE_DEPENDENCY_GRAPH)
        ...
        if(_type MATCHES SHARED_LIBRARY|MODULE_LIBRARY OR ${_node} MATCHES ntoskrnl)
            file(APPEND ${MERGEOS_BINARY_DIR}/dependencies.graphml "    <node id=\"${_node}\"/>\n")
        endif()
     endif()
endfunction()
...
function(add_dependency_edge _source _target)
    if(GENERATE_DEPENDENCY_GRAPH)
        ...
        if(_type MATCHES SHARED_LIBRARY|MODULE_LIBRARY)
            file(APPEND ${MERGEOS_BINARY_DIR}/dependencies.graphml "    <edge source=\"${_source}\" target=\"${_target}\"/>\n")
        endif()
    endif()
endfunction()
...
function(add_dependency_header)
    if(GENERATE_DEPENDENCY_GRAPH)
        file(WRITE ${MERGEOS_BINARY_DIR}/dependencies.graphml "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<graphml>\n  <graph id=\"MergeOS dependencies\" edgedefault=\"directed\">\n")
    endif()
endfunction()
...
function(add_dependency_footer)
    if(GENERATE_DEPENDENCY_GRAPH)
        ...
        file(APPEND ${MERGEOS_BINARY_DIR}/dependencies.graphml "  </graph>\n</graphml>\n")
    endif()
endfunction()
...
# boot/bootdata/packages/mergeos.dff.in
#
macro(dir_to_num dir var)
    if(${dir} STREQUAL mergeos)
        set(${var} 1)
    elseif(${dir} STREQUAL mergeos/system32)
        set(${var} 2)
    elseif(${dir} STREQUAL mergeos/system32/drivers)
        set(${var} 3)
    elseif(${dir} STREQUAL mergeos/Fonts)
        set(${var} 4)
    elseif(${dir} STREQUAL mergeos/system32/drivers/etc)
        set(${var} 5)
    elseif(${dir} STREQUAL mergeos/inf)
        set(${var} 6)
    elseif(${dir} STREQUAL mergeos/bin)
        set(${var} 7)
    elseif(${dir} STREQUAL mergeos/bin/testdata)
        set(${var} 8)
    elseif(${dir} STREQUAL mergeos/media)
        set(${var} 9)
    elseif(${dir} STREQUAL mergeos/Microsoft.NET)
        set(${var} 10)
    elseif(${dir} STREQUAL mergeos/Microsoft.NET/Framework)
        set(${var} 11)
    elseif(${dir} STREQUAL mergeos/Microsoft.NET/Framework/v1.0.3705)
        set(${var} 12)
    elseif(${dir} STREQUAL mergeos/Microsoft.NET/Framework/v1.1.4322)
        set(${var} 13)
    elseif(${dir} STREQUAL mergeos/Microsoft.NET/Framework/v2.0.50727)
        set(${var} 14)
    elseif(${dir} STREQUAL mergeos/Resources)
        set(${var} 15)
    elseif(${dir} STREQUAL mergeos/Resources/Themes)
        set(${var} 16)
    elseif(${dir} STREQUAL mergeos/system32/wbem)
        set(${var} 17)
    elseif(${dir} STREQUAL mergeos/Resources/Themes/Lautus)
        set(${var} 18)
    elseif(${dir} STREQUAL mergeos/Help)
        set(${var} 19)
    elseif(${dir} STREQUAL mergeos/Config)
        set(${var} 20)
    elseif(${dir} STREQUAL mergeos/Cursors)
        set(${var} 21)
    elseif(${dir} STREQUAL mergeos/system32/ShellExt)
        set(${var} 22)
    elseif(${dir} STREQUAL mergeos/Temp)
        set(${var} 23)
    elseif(${dir} STREQUAL mergeos/system32/spool)
        set(${var} 24)
    elseif(${dir} STREQUAL mergeos/system32/spool/drivers)
        set(${var} 25)
    elseif(${dir} STREQUAL mergeos/system32/spool/drivers/color)
        set(${var} 26)
    elseif(${dir} STREQUAL mergeos/system32/spool/drivers/w32x86)
        set(${var} 27)
    elseif(${dir} STREQUAL mergeos/system32/spool/drivers/w32x86/3)
        set(${var} 28)
    elseif(${dir} STREQUAL mergeos/system32/spool/prtprocs)
        set(${var} 29)
    elseif(${dir} STREQUAL mergeos/system32/spool/prtprocs/w32x86)
        set(${var} 30)
    elseif(${dir} STREQUAL mergeos/system32/spool/PRINTERS)
        set(${var} 31)
    elseif(${dir} STREQUAL mergeos/system32/wbem/Repository)
        set(${var} 32)
    elseif(${dir} STREQUAL mergeos/system32/wbem/Repository/FS)
        set(${var} 33)
    elseif(${dir} STREQUAL mergeos/system32/wbem/mof/good)
        set(${var} 34)
    elseif(${dir} STREQUAL mergeos/system32/wbem/mof/bad)
        set(${var} 35)
    elseif(${dir} STREQUAL mergeos/system32/wbem/AdStatus)
        set(${var} 36)
    elseif(${dir} STREQUAL mergeos/system32/wbem/xml)
        set(${var} 37)
    elseif(${dir} STREQUAL mergeos/system32/wbem/Logs)
        set(${var} 38)
    elseif(${dir} STREQUAL mergeos/system32/wbem/AutoRecover)
        set(${var} 39)
    elseif(${dir} STREQUAL mergeos/system32/wbem/snmp)
        set(${var} 40)
    elseif(${dir} STREQUAL mergeos/system32/wbem/Performance)
        set(${var} 41)
    elseif(${dir} STREQUAL mergeos/twain_32)
        set(${var} 42)
    elseif(${dir} STREQUAL mergeos/repair)
        set(${var} 43)
    elseif(${dir} STREQUAL mergeos/Web)
        set(${var} 44)
    elseif(${dir} STREQUAL mergeos/Web/Wallpaper)
        set(${var} 45)
    elseif(${dir} STREQUAL mergeos/Prefetch)
        set(${var} 46)
    elseif(${dir} STREQUAL mergeos/security)
        set(${var} 47)
    elseif(${dir} STREQUAL mergeos/security/Database)
        set(${var} 48)
    elseif(${dir} STREQUAL mergeos/security/logs)
        set(${var} 49)
    elseif(${dir} STREQUAL mergeos/security/templates)
        set(${var} 50)
    elseif(${dir} STREQUAL mergeos/system32/CatRoot)
        set(${var} 51)
    elseif(${dir} STREQUAL mergeos/system32/CatRoot2)
        set(${var} 52)
    elseif(${dir} STREQUAL mergeos/AppPatch)
        set(${var} 53)
    elseif(${dir} STREQUAL mergeos/winsxs)
        set(${var} 54)
    elseif(${dir} STREQUAL mergeos/winsxs/manifests)
        set(${var} 55)
    elseif(${dir} STREQUAL mergeos/winsxs/x86_microsoft.windows.common-controls_6595b64144ccf1df_5.82.2600.2982_none_deadbeef)
        set(${var} 56)
    elseif(${dir} STREQUAL mergeos/winsxs/x86_microsoft.windows.common-controls_6595b64144ccf1df_6.0.2600.2982_none_deadbeef)
        set(${var} 57)
    elseif(${dir} STREQUAL mergeos/winsxs/x86_microsoft.windows.gdiplus_6595b64144ccf1df_1.1.7601.23038_none_deadbeef)
        set(${var} 58)
    elseif(${dir} STREQUAL mergeos/winsxs/x86_mergeos.apisets_6595b64144ccf1df_1.0.0.0_none_deadbeef)
        set(${var} 59)
    elseif(${dir} STREQUAL mergeos/bin/suppl)
        set(${var} 60)
    elseif(${dir} STREQUAL mergeos/winsxs/x86_microsoft.windows.gdiplus_6595b64144ccf1df_1.0.14393.0_none_deadbeef)
        set(${var} 61)
    elseif(${dir} STREQUAL mergeos/Resources/Themes/Modern)
        set(${var} 62)
    elseif(${dir} STREQUAL mergeos/3rdParty)
        set(${var} 63)
    elseif(${dir} STREQUAL mergeos/Resources/Themes/Lunar)
        set(${var} 64)
    elseif(${dir} STREQUAL mergeos/Resources/Themes/Mizu)
        set(${var} 65)
    elseif(${dir} STREQUAL mergeos/system32/spool/prtprocs/x64)
        set(${var} 66)
    elseif(${dir} STREQUAL mergeos/winsxs/amd64_microsoft.windows.common-controls_6595b64144ccf1df_5.82.2600.2982_none_deadbeef)
        set(${var} 67)
    elseif(${dir} STREQUAL mergeos/winsxs/amd64_microsoft.windows.common-controls_6595b64144ccf1df_6.0.2600.2982_none_deadbeef)
        set(${var} 68)
    elseif(${dir} STREQUAL mergeos/winsxs/amd64_microsoft.windows.gdiplus_6595b64144ccf1df_1.1.7601.23038_none_deadbeef)
        set(${var} 69)
    elseif(${dir} STREQUAL mergeos/winsxs/amd64_mergeos.apisets_6595b64144ccf1df_1.0.0.0_none_deadbeef)
        set(${var} 70)
    elseif(${dir} STREQUAL mergeos/winsxs/amd64_microsoft.windows.gdiplus_6595b64144ccf1df_1.0.14393.0_none_deadbeef)
        set(${var} 71)

    elseif(${dir} STREQUAL mergeos/winsxs/arm_microsoft.windows.common-controls_6595b64144ccf1df_5.82.2600.2982_none_deadbeef)
        set(${var} 72)
    elseif(${dir} STREQUAL mergeos/winsxs/arm_microsoft.windows.common-controls_6595b64144ccf1df_6.0.2600.2982_none_deadbeef)
        set(${var} 73)
    elseif(${dir} STREQUAL mergeos/winsxs/arm_microsoft.windows.gdiplus_6595b64144ccf1df_1.1.7601.23038_none_deadbeef)
        set(${var} 74)
    elseif(${dir} STREQUAL mergeos/winsxs/arm_mergeos.apisets_6595b64144ccf1df_1.0.0.0_none_deadbeef)
        set(${var} 75)
    elseif(${dir} STREQUAL mergeos/winsxs/arm_microsoft.windows.gdiplus_6595b64144ccf1df_1.0.14393.0_none_deadbeef)
        set(${var} 76)

    elseif(${dir} STREQUAL mergeos/winsxs/arm64_microsoft.windows.common-controls_6595b64144ccf1df_5.82.2600.2982_none_deadbeef)
        set(${var} 77)
    elseif(${dir} STREQUAL mergeos/winsxs/arm64_microsoft.windows.common-controls_6595b64144ccf1df_6.0.2600.2982_none_deadbeef)
        set(${var} 78)
    elseif(${dir} STREQUAL mergeos/winsxs/arm64_microsoft.windows.gdiplus_6595b64144ccf1df_1.1.7601.23038_none_deadbeef)
        set(${var} 79)
    elseif(${dir} STREQUAL mergeos/winsxs/arm64_mergeos.apisets_6595b64144ccf1df_1.0.0.0_none_deadbeef)
        set(${var} 80)
    elseif(${dir} STREQUAL mergeos/winsxs/arm64_microsoft.windows.gdiplus_6595b64144ccf1df_1.0.14393.0_none_deadbeef)
        set(${var} 81)
...
function(add_cd_file)
    ...
    if(NOT __cd EQUAL -1)
        # whether or not we should put it in mergeos.cab or directly on cd
        if(_CD_NO_CAB)
            # directly on cd
            ...
            foreach(item ${_CD_FILE})
                # add it in mergeos.cab
                file(APPEND ${MERGEOS_BINARY_DIR}/boot/bootdata/packages/mergeos.dff.cmake "\"${item}\" ${_num}\n")

                # manage dependency - file level
                set_property(GLOBAL APPEND PROPERTY MERGEOS_CAB_DEPENDS ${item})
            endforeach()

            # manage dependency - target level
            if(_CD_TARGET)
                add_dependencies(mergeos_cab_inf ${_CD_TARGET})
            endif()
        endif()
    endif() #end bootcd
    ...
    if(NOT __cd EQUAL -1)
        ...
        if(_CD_NO_CAB)
            ...
            #add it in mergeos.cab
            #dir_to_num(${_CD_DESTINATION} _num)
            #file(APPEND ${MERGEOS_BINARY_DIR}/boot/bootdata/packages/mergeos.dff.dyn "${_CD_FILE} ${_num}\n")
            #if(_CD_TARGET)
            #    #manage dependency
            #    add_dependencies(mergeos_cab ${_CD_TARGET})
            #endif()
        endif()
    endif() #end bootcd
endfunction()
...
function(create_iso_lists)
    # generate mergeos.cab before anything else
    get_property(_filelist GLOBAL PROPERTY MERGEOS_CAB_DEPENDS)

    # begin with mergeos.inf. We want this command to be always executed, so we pretend it generates another file although it will never do.
    add_custom_command(
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/mergeos.inf ${CMAKE_CURRENT_BINARY_DIR}/__some_non_existent_file
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${MERGEOS_BINARY_DIR}/boot/bootdata/packages/mergeos.inf ${CMAKE_CURRENT_BINARY_DIR}/mergeos.inf
        DEPENDS ${MERGEOS_BINARY_DIR}/boot/bootdata/packages/mergeos.inf mergeos_cab_inf)

    add_custom_command(
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/mergeos.cab
        COMMAND native-cabman -C ${MERGEOS_BINARY_DIR}/boot/bootdata/packages/mergeos.dff -RC ${CMAKE_CURRENT_BINARY_DIR}/mergeos.inf -N -P ${MERGEOS_SOURCE_DIR}
        DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/mergeos.inf native-cabman ${_filelist})

    add_custom_target(mergeos_cab DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/mergeos.cab)
    add_dependencies(mergeos_cab mergeos_cab_inf)

    add_cd_file(
        TARGET mergeos_cab
        FILE ${CMAKE_CURRENT_BINARY_DIR}/mergeos.cab
        DESTINATION mergeos
    ...
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${MERGEOS_BINARY_DIR}/boot/bootcd.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${MERGEOS_BINARY_DIR}/boot/bootcd.$<CONFIG>.lst
         INPUT ${MERGEOS_BINARY_DIR}/boot/bootcd.cmake.lst)

    get_property(_filelist GLOBAL PROPERTY LIVECD_FILE_LIST)
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${MERGEOS_BINARY_DIR}/boot/livecd.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${MERGEOS_BINARY_DIR}/boot/livecd.$<CONFIG>.lst
         INPUT ${MERGEOS_BINARY_DIR}/boot/livecd.cmake.lst)

    get_property(_filelist GLOBAL PROPERTY HYBRIDCD_FILE_LIST)
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${MERGEOS_BINARY_DIR}/boot/hybridcd.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${MERGEOS_BINARY_DIR}/boot/hybridcd.$<CONFIG>.lst
         INPUT ${MERGEOS_BINARY_DIR}/boot/hybridcd.cmake.lst)

    get_property(_filelist GLOBAL PROPERTY BOOTCDREGTEST_FILE_LIST)
    string(REPLACE ";" "\n" _filelist "${_filelist}")
    file(APPEND ${MERGEOS_BINARY_DIR}/boot/bootcdregtest.cmake.lst "${_filelist}")
    unset(_filelist)
    file(GENERATE
         OUTPUT ${MERGEOS_BINARY_DIR}/boot/bootcdregtest.$<CONFIG>.lst
         INPUT ${MERGEOS_BINARY_DIR}/boot/bootcdregtest.cmake.lst)
endfunction()
...
function(add_clean_target _target)
    ...
    elseif(CMAKE_GENERATOR STREQUAL "Ninja")
        ...
        set(_clean_working_directory ${MERGEOS_BINARY_DIR})
    endif()
...
function(set_module_type MODULE TYPE)
    ...
    set_target_properties(${MODULE} PROPERTIES MERGEOS_MODULE_TYPE ${TYPE})
...
function(create_registry_hives)
    ...
    add_cd_file(
        FILE ${CMAKE_BINARY_DIR}/boot/bootdata/system
             ...
             ${CMAKE_BINARY_DIR}/boot/bootdata/security
        TARGET livecd_hives
        DESTINATION mergeos/system32/config
        FOR livecd)
...
function(add_driver_inf _module)
    ...
    add_cd_file(FILE ${_converted_inf_files} TARGET ${_module}_inf_files DESTINATION mergeos/inf FOR all)
endfunction()
...
function(add_rostests_file)
    ...
    if(_ROSTESTS_TARGET)
        add_cd_file(TARGET ${_ROSTESTS_TARGET} FILE ${_ROSTESTS_FILE} DESTINATION "mergeos/bin${_ROSTESTS_SUBDIR}" NAME_ON_CD ${_ROSTESTS_NAME_ON_CD} FOR all)
    else()
        add_cd_file(FILE ${_ROSTESTS_FILE} DESTINATION "mergeos/bin${_ROSTESTS_SUBDIR}" NAME_ON_CD ${_ROSTESTS_NAME_ON_CD} FOR all)
    endif()
