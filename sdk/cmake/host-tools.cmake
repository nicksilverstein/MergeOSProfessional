...
function(setup_host_tools)
    ...
    list(TRANSFORM HOST_TOOLS PREPEND "${MERGEOS_BINARY_DIR}/host-tools/bin/" OUTPUT_VARIABLE HOST_TOOLS_OUTPUT)
    if (CMAKE_HOST_WIN32)
    ...
    elseif(MSVC)
        ...
        set(HOST_TOOLS_CMAKE_COMMAND "${MERGEOS_BINARY_DIR}/host-tools/cmake_shim.cmd")
    ...
    ExternalProject_Add(host-tools
        SOURCE_DIR ${MERGEOS_SOURCE_DIR}
        PREFIX ${MERGEOS_BINARY_DIR}/host-tools
        BINARY_DIR ${MERGEOS_BINARY_DIR}/host-tools/bin
        CMAKE_COMMAND ${HOST_TOOLS_CMAKE_COMMAND}
        CMAKE_ARGS
            -UCMAKE_TOOLCHAIN_FILE
            -DARCH:STRING=${ARCH}
            -DCMAKE_INSTALL_PREFIX=${MERGEOS_BINARY_DIR}/host-tools
            -DTOOLS_FOLDER=${MERGEOS_BINARY_DIR}/host-tools/bin
