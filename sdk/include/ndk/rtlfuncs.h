...
#ifdef __MERGEOS__ // MergeOS improvement
...
#if (_WIN32_WINNT >= _WIN32_WINNT_VISTA) || (defined(__MERGEOS__) && defined(_NTDLLBUILD_))
...
#endif /* Win vista or Mergeos Ntdll build */

#if (_WIN32_WINNT >= _WIN32_WINNT_WIN7) || (defined(__MERGEOS__) && defined(_NTDLLBUILD_))
...
#endif /* Win7 or Mergeos Ntdll build */
