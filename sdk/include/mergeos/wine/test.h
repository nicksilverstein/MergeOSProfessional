...
#define todo_ros                todo_if(!strcmp(winetest_platform, "mergeos"))
#define todo_ros_if(is_todo)    todo_if((is_todo) && !strcmp(winetest_platform, "mergeos"))
...
int broken( int condition )
{
    ...
    || (strcmp(winetest_platform, "mergeos") == 0)
#endif
    ) && condition;
}
...
const char *wine_dbgstr_longlong( ULONGLONG ll )
{
    ...
    if (/*sizeof(ll) > sizeof(unsigned long) &&*/ ll >> 32) /* ULONGLONG is always > long in MergeOS */
