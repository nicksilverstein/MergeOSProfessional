...
Severity=Informational
Facility=System
SymbolicName=MERGEOS_COPYRIGHT_NOTICE
Language=English
\n\nMergeOS is free software, covered by the GNU General Public License,
 and you\n are welcome to change it and/or distribute copies of it under
 certain\n conditions. There is absolutely no warranty for MergeOS.\n
.
...
Language=English
A problem has been detected and MergeOS has been shut down to prevent damage
to your computer.
.
...
for any MergeOS updates you might need.
...
Language=English
A system file that is owned by MergeOS was replaced by an application
...
has prevented MergeOS from operating.  You can determine which component is
...
hardware problem thereby allowing MergeOS to operate.
.
