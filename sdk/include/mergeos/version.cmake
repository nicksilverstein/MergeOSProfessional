option(NO_MERGEOS_BUILDNO "If true, disables the generation of buildno.h and version.h for each configure" OFF)

if (NOT NO_MERGEOS_BUILDNO)
...
math(EXPR MERGEOS_DLL_VERSION_MAJOR "${KERNEL_VERSION_MAJOR}+42")
set(DLL_VERSION_STR "${MERGEOS_DLL_VERSION_MAJOR}.${KERNEL_VERSION_MINOR}.${KERNEL_VERSION_PATCH_LEVEL}")
if(NOT KERNEL_VERSION_BUILD_TYPE STREQUAL "")
...
if((EXISTS "${MERGEOS_SOURCE_DIR}/.git") AND (NOT NO_MERGEOS_BUILDNO))
    find_package(Git)
    if(GIT_FOUND)
        execute_process(
            COMMAND "${GIT_EXECUTABLE}" rev-parse HEAD
            WORKING_DIRECTORY ${MERGEOS_SOURCE_DIR}
...
configure_file(sdk/include/mergeos/version.h.cmake ${MERGEOS_BINARY_DIR}/sdk/include/mergeos/version.h)
configure_file(sdk/include/mergeos/buildno.h.cmake ${MERGEOS_BINARY_DIR}/sdk/include/mergeos/buildno.h)
