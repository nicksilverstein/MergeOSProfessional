/*
 * PROJECT:     MergeOS SM Helper Library
 * LICENSE:     GPL-2.0-or-later (https://spdx.org/licenses/GPL-2.0-or-later)
 * PURPOSE:     Utility functions built around the client SM API
 * COPYRIGHT:   Copyright 2005 Emanuele Aliberti <ea@mergeos.com>
 ...
 *
 * @remark
 * This API is MergeOS-specific and not in NT.
 */
NTSTATUS
NTAPI
SmQueryInformation(
