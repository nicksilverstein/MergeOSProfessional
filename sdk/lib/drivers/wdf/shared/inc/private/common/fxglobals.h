...
// MERGEOS
#define ROSWDFNOTIMPLEMENTED (DbgPrint("(%s:%d) MergeOS KMDF: %s not implemented\n", __RELFILE__, __LINE__, __FUNCTION__))
// MERGEOS
...
struct FxLibraryGlobalsType {
    ...
    //
    //PWMI_WDF_NOTIFY_ROUTINES PerfTraceRoutines; __MERGEOS__
    ...
    //
    //WMI_WDF_NOTIFY_ROUTINES DummyPerfTraceRoutines; __MERGEOS__
