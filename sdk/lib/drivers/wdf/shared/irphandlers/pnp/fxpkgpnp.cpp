  ...
  --*/
{
    ...
    if (Settings->UserControlOfIdleSettings == IdleAllowUserControl) {
        ...
        // (void) UpdateWmiInstanceForS0Idle(RemoveInstance); __MERGEOS__
    }
  ...
  --*/
{
    ...
    if (Settings->UserControlOfWakeSettings == WakeAllowUserControl) {
        ...
        // status = UpdateWmiInstanceForSxWake(AddInstance); __MERGEOS__
        ...
        // (void) UpdateWmiInstanceForSxWake(RemoveInstance); __MERGEOS__
    }
