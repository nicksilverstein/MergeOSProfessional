/*
 * MergeOS Cancel-Safe Queue library
 * Copyright (c) 2004, Vizzini (vizzini@plasmic.com)
 * Licensed under the GNU GPL for the MergeOS project
 *
 * This file implements the MergeOS CSQ library.  For background and overview
