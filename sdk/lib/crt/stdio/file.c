 ...
 *                  Ported to MergeOS by Aleksey Bragin (aleksey@reactos.org)
 */

/*********************************************
 * This file contains MergeOS changes!!
...
#ifdef __MERGEOS__ /* CORE-11949 */
    file->_ptr=file->_base;
    file->_cnt=0;
#endif
    }

#ifndef __MERGEOS__ /* CORE-11949 */
    file->_ptr=file->_base;
    file->_cnt=0;
#endif
    return 0;
...
void CDECL _lock_file(FILE *file)
{
    ...
    /* MergeOS: string streams dont need to be locked */
...
/*********************************************************************
 *		fputwc (MSVCRT.@)
 * FORKED for MergeOS, don't sync with Wine!
 * References:
