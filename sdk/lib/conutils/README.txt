The MergeOS Console Utilities Library v0.2
==========================================

LICENSE:    GPL-2.0+ (https://spdx.org/licenses/GPL-2.0+)
COPYRIGHT:  Copyright 2017-2018 MergeOS Team
...
This library contains common functions used in many places inside the MergeOS
console utilities and the MergeOS Command-Line Interpreter. Most of these
