/*
 * PROJECT:     MergeOS Console Utilities Library
 ...
 * @ingroup ConUtils
 *
 * @defgroup ConUtils   MergeOS Console Utilities Library
 *
 * @brief   This library contains common functions used in many places inside
 *          the MergeOS console utilities and the MergeOS Command-Line Interpreter.
